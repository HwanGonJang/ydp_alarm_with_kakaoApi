...
if t[r] == "월":
    ...
    classTime21 = "토,일요일은 수업이 없습니다\n"

class21 = sub + bar + classTime21 + bar + danger
#======================================class21end
#======================================class22
if t[r] == "월":
    classTime22 = "1교시: 일어\n2교시: 영A\n3교시: 환경\n4교시: 확통\n5교시: 윤사\n6교시: 독A\n7교시: 세지\n"
    ...
    classTime22 = "토,일요일은 수업이 없습니다\n"
    
class22 = sub + bar + classTime22 + bar + danger
#======================================class22end
#======================================class23
if t[r] == "월":
    classTime23 = "1교시: 윤사\n2교시: 일어\n3교시: 독A\n4교시: 세지\n5교시: 체육\n6교시: 독B\n7교시: 미술\n"
    ...
    classTime23 = "토,일요일은 수업이 없습니다\n"
    
class23 = sub + bar + classTime23 + bar + danger
#======================================class23end
#======================================class24
if t[r] == "월":
    classTime24 = "1교시: 미술\n2교시: 중어\n3교시: 진로\n4교시: 확통\n5교시: 영A\n6교시: 윤사\n7교시: 독A\n"
...
if t[r] == "월":
    ...
    classTime25 = "토,일요일은 수업이 없습니다\n"
    
class25 = sub + bar + classTime25 + bar + danger
#=======================================class25end
#=================================class26
if t[r] == "월":
    classTime26 = "1교시: 생물\n2교시: 체육\n3교시: 화학\n4교시: 물리\n5교시: 독C\n6교시: 영A\n7교시: 확통\n"
...
if t[r] == "월":
    ...
    classTime27 = "토,일요일은 수업이 없습니다\n"
    
class27 = sub + bar + classTime27 + bar + danger
#===============================class27end
#=============================class28
if t[r] == "월":
    classTime28 = "1교시: 융합\n2교시: 독B\n3교시: 영A\n4교시: 지학\n5교시: 미적\n6교시: 실험\n7교시: 실험\n"
    ...
    classTime28 = "토,일요일은 수업이 없습니다\n"
    
class28 = sub + bar + classTime28 + bar + danger
#==============================class28end
#===============================class31
if t[r] == "월":
    classTime = "1교시: 작A\n2교시: 한A\n3교시: 한지\n4교시: 지학\n5교시: 영A\n6교시: 체육\n7교시: 확통\n"
...
def keyboard(request):
    ...
    return JsonResponse({
        'type':'buttons',
        'buttons':['공지','급식','인성스포츠대회 경기일정','선생님 위치 정보','시간표','영등포고등학교 홈페이지','오늘 경기','개발정보']
    })
...
def message(request):
    ...
    if datacontent == '급식':
        ...
        return JsonResponse({
                'message': {
                    'text': '1. 2학년 2학기 시간표로 수정됬습니다.\n(1,3학년은 수정중입니다.)\n\n2. 인성스포츠대회 경기일정이 이제 이미지로 업로드 되었습니다.\n(1. 링크 이미지 이므로 확대는 불가능합니다.\n2. 오늘의 경기는 수정중에 있고, 이 기능은 삭제 될수 있습니다.)\n\n3. 오늘의 명언 기능이 삭제되었습니다.(이유 : http error 403 해결 불가)\n\n4. 다른 공지사항이 있으면 1대1 상담에 올려주시면 참고하겠습니다.'
                },
                'keyboard': {
                    'type':'buttons',
                    'buttons':['처음으로']
        ...
        return JsonResponse({
                'message': {
		  "photo": {
     	 	    "url": "https://lh3.googleusercontent.com/alDz-n3U2GqpWyesGvuGlmTphffJTZ7Rs8cGWMtIVPRw-8hg0JaRmHYiGE7-2POROifx8Dw3O7oUyxESrc8n=w1920-h1012-rw",
      		    "width": 1705,
      		    "height": 1761
   		  }
                },
